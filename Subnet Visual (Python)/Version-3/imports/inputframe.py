...
class IPv4EntryFrame(tk.Frame):
    def __init__(self, 
                 ...
                 outerborderwidths: tuple = (2, 2, 2, 2),
...
class InputSummaryImageFrame(tk.Frame):
    def __init__(self, 
            ...
            idx = 1
            for i in range(0, 32, 8):
                b = BorderedFrame(self.inner, interior=tk.Frame, bordercolor=bordercolor, borderwidths=(1, 1, 0, 0), height=15)
            ...
            cidr_prefix = BorderedFrame(cidr_frame, borderwidths=(2,2,2,2), bordercolor="systemTextColor", interior=tk.Entry, width=16, justify=tk.CENTER, textvariable=self.fields.cidr_notation, font=font, state="readonly", readonlybackground="systemTextBackgroundColor")
            ...
            network_bits = BorderedFrame(cidr_frame, borderwidths=(2,2,2,2), bordercolor="systemTextColor", interior=tk.Entry, width=2, justify=tk.CENTER, textvariable=self.fields.network_bits, bd=0, font=font, state="readonly", highlightbackground=self.colors["network"], readonlybackground=self.colors["network"])
            ...
            host_bits = BorderedFrame(cidr_frame, borderwidths=(2,2,2,2), bordercolor="systemTextColor", interior=tk.Entry, width=2, justify=tk.CENTER, textvariable=self.fields.host_bits, bd=0, font=font, state="readonly", highlightbackground=self.colors["host"], readonlybackground=self.colors["host"])
            ...
            total_addresses = BorderedFrame(cidr_frame, borderwidths=(2,2,2,2), bordercolor="systemTextColor", interior=tk.Entry, width=15, justify=tk.CENTER, textvariable=self.fields.total_addresses, font=font, state="readonly", readonlybackground="systemTextBackgroundColor")
            ...
            usable_hosts = BorderedFrame(cidr_frame, borderwidths=(1,1,1,1), bordercolor="#BD86FF", interior=tk.Entry, width=15, justify=tk.CENTER, textvariable=self.fields.usable_hosts, font=font, state="readonly", readonlybackground="systemTextBackgroundColor")
            ...
            subnet_cidr_prefix = BorderedFrame(subnet_frame, borderwidths=(2,2,2,2), bordercolor="systemTextColor", interior=tk.Entry, width=16, justify=tk.CENTER, textvariable=self.fields.subnet.cidr_prefix, font=font, state="readonly", readonlybackground="systemTextBackgroundColor")
            ...
            subnet_host_bits = BorderedFrame(subnet_frame, borderwidths=(2,2,2,2), bordercolor="systemTextColor", interior=tk.Entry, width=2, justify=tk.CENTER, textvariable=self.fields.subnet.subnet_bits, bd=0, font=font, state="readonly", highlightbackground=self.colors["subnet"], readonlybackground=self.colors["subnet"])
            ...
            subnet_bits = BorderedFrame(subnet_frame, borderwidths=(2,2,2,2), bordercolor="systemTextColor", interior=tk.Entry, width=2, justify=tk.CENTER, textvariable=self.fields.subnet.host_bits, bd=0, font=font, state="readonly", highlightbackground=self.colors["host"], readonlybackground=self.colors["host"])
            ...
            addresses_per_subnet = BorderedFrame(subnet_frame, borderwidths=(2,2,2,2), bordercolor="systemTextColor", interior=tk.Entry, width=15, justify=tk.CENTER, textvariable=self.fields.subnet.addresses_per_subnet, font=font, state="readonly", readonlybackground="systemTextBackgroundColor")
            ...
            number_of_subnets = BorderedFrame(subnet_frame, borderwidths=(2,2,2,2), bordercolor="systemTextColor", interior=tk.Entry, width=15, justify=tk.CENTER, textvariable=self.fields.subnet.number_of_subnets, font=font, state="readonly", readonlybackground="systemTextBackgroundColor")
            ...
            # BorderedFrame(fr, borderwidths=(2,2,2,2), bordercolor="systemTextColor", interior=tk.Entry, width=2, justify=tk.CENTER, textvariable=self.fields.ip_class, font=font, state="readonly", readonlybackground="systemTextBackgroundColor").grid(column=1, row=0, padx=5, pady=5, sticky="W")


            # fr2 = tk.Frame(self.inner)
            # tk.Label(fr2, text="First Octet Range: ", font=font).grid(column=0, row=1, sticky="E")
            # BorderedFrame(fr2, borderwidths=(2,2,2,2), bordercolor="systemTextColor", interior=tk.Entry, width=10, justify=tk.CENTER, textvariable=self.class_range_var, font=font, state="readonly", readonlybackground="systemTextBackgroundColor").grid(column=1, row=1, padx=5, pady=5, sticky="W")
...
class IPv4ClassFrame(tk.Frame):
    def __init__(self, 
            ...
            BorderedFrame(self.inner, borderwidths=(2,2,2,2), bordercolor="systemTextColor", interior=tk.Entry, width=2, justify=tk.CENTER, textvariable=self.fields.ip_class, font=font, state="readonly", readonlybackground="systemTextBackgroundColor").grid(column=1, row=1, padx=5, pady=5, sticky="W")

            tk.Label(self.inner, text="First Octet Range: ", font=font).grid(column=0, row=2, sticky="E")
            BorderedFrame(self.inner, borderwidths=(2,2,2,2), bordercolor="systemTextColor", interior=tk.Entry, width=10, justify=tk.CENTER, textvariable=self.class_range_var, font=font, state="readonly", readonlybackground="systemTextBackgroundColor").grid(column=1, row=2, padx=5, pady=5, sticky="W")
...
class IPv4SpecialFrame(tk.Frame):
    def __init__(self, 
            ...
            BorderedFrame(type_frame, borderwidths=(2,2,2,2), bordercolor="systemTextColor", interior=tk.Entry, width=10, justify=tk.CENTER, textvariable=self.fields.public_or_private, font=font, state="readonly", readonlybackground="systemTextBackgroundColor").grid(column=1, row=0, padx=5, pady=(5, 10), sticky="W")
            ...
            BorderedFrame(self.inner, borderwidths=(2,2,2,2), bordercolor="systemTextColor", interior=tk.Entry, width=40, justify=tk.CENTER, textvariable=self.fields.special_notes, font=font, state="readonly", readonlybackground="systemTextBackgroundColor").grid(column=1, row=2, padx=5, sticky="W", columnspan=2)
...
class IPv4MaskingFrame(tk.Frame):
    def __init__(self, 
            ...
            idx += 1
            for i in range(4):
                octet = CombFrame(self, outerborderwidths=(2,2,2,2), bordercolor="systemTextColor", widget=FixedSizeFramedLabel, width=35, height=15, justify=tk.CENTER, varslist=[ip.decimal_octets[i]], font=font, background="systemTextBackgroundColor")
                octet.grid(row=0, column=idx, pady=5, sticky="NSEW")

                mask_octet = CombFrame(self, outerborderwidths=(2,2,2,2), bordercolor="systemTextColor", widget=FixedSizeFramedLabel, width=35, height=15, justify=tk.CENTER, varslist=[mask.decimal_octets[i]], font=font, background="systemTextBackgroundColor")
                mask_octet.grid(row=1, column=idx, pady=5, sticky="NSEW")

                result_octet = CombFrame(self, outerborderwidths=(2,2,2,2), bordercolor="systemTextColor", widget=FixedSizeFramedLabel, width=35, height=15, justify=tk.CENTER, varslist=[result.decimal_octets[i]], font=font, background="systemTextBackgroundColor")
                result_octet.grid(row=3, column=idx, pady=5, sticky="NSEW")

                arrow_octet = CombFrame(self, outerborderwidths=(2,2,2,2), bordercolor=bg, widget=FixedSizeFramedLabel, width=35, height=15, justify=tk.CENTER, textlist=["\u21E9"], font=font)
                arrow_octet.grid(row=2, column=idx, sticky="NSEW")
...
class IPv4SummaryFrame(tk.Frame):
    def __init__(self, 
        ...
        BorderedFrame(self.inner, borderwidths=(2,2,2,2), bordercolor="systemTextColor", interior=tk.Entry, width=widths[0], justify=tk.CENTER, textvariable=self.fields.ip.dotted_quad, font=font, state="readonly", readonlybackground="systemTextBackgroundColor").grid(column=dec_col, row=0, padx=padx, pady=pady)
        BorderedFrame(self.inner, borderwidths=(2,2,2,2), bordercolor="systemTextColor", interior=tk.Entry, width=widths[1], justify=tk.CENTER, textvariable=self.fields.ip.binary_quad, font=font, state="readonly", readonlybackground="systemTextBackgroundColor").grid(column=bin_col, row=0, padx=padx, pady=pady)
        BorderedFrame(self.inner, borderwidths=(2,2,2,2), bordercolor="systemTextColor", interior=tk.Entry, width=widths[2], justify=tk.CENTER, textvariable=self.fields.ip.hex_quad, font=font, state="readonly", readonlybackground="systemTextBackgroundColor").grid(column=hex_col, row=0, padx=padx, pady=pady)
        BorderedFrame(self.inner, borderwidths=(2,2,2,2), bordercolor="systemTextColor", interior=tk.Entry, width=widths[3], justify=tk.CENTER, textvariable=self.fields.ip.long, font=font, state="readonly", readonlybackground="systemTextBackgroundColor").grid(column=long_col, row=0, padx=padx, pady=pady)


        tk.Label(self.inner, text="Netmask:", font=font).grid(column=title_col, row=1, padx=label_padx)
        BorderedFrame(self.inner, borderwidths=(2,2,2,2), bordercolor="systemTextColor", interior=tk.Entry, width=widths[0], justify=tk.CENTER, textvariable=self.fields.netmask.dotted_quad, font=font, state="readonly", readonlybackground="systemTextBackgroundColor").grid(column=dec_col, row=1, padx=padx, pady=pady)
        BorderedFrame(self.inner, borderwidths=(2,2,2,2), bordercolor="systemTextColor", interior=tk.Entry, width=widths[1], justify=tk.CENTER, textvariable=self.fields.netmask.binary_quad, font=font, state="readonly", readonlybackground="systemTextBackgroundColor").grid(column=bin_col, row=1, padx=padx, pady=pady)
        BorderedFrame(self.inner, borderwidths=(2,2,2,2), bordercolor="systemTextColor", interior=tk.Entry, width=widths[2], justify=tk.CENTER, textvariable=self.fields.netmask.hex_quad, font=font, state="readonly", readonlybackground="systemTextBackgroundColor").grid(column=hex_col, row=1, padx=padx, pady=pady)
        BorderedFrame(self.inner, borderwidths=(2,2,2,2), bordercolor="systemTextColor", interior=tk.Entry, width=widths[3], justify=tk.CENTER, textvariable=self.fields.netmask.long, font=font, state="readonly", readonlybackground="systemTextBackgroundColor").grid(column=long_col, row=1, padx=padx, pady=pady)


        tk.Label(self.inner, text="Wildcard:", font=font).grid(column=title_col, row=2, padx=label_padx)
        BorderedFrame(self.inner, borderwidths=(2,2,2,2), bordercolor="systemTextColor", interior=tk.Entry, width=widths[0], justify=tk.CENTER, textvariable=self.fields.wildcard.dotted_quad, font=font, state="readonly", readonlybackground="systemTextBackgroundColor").grid(column=dec_col, row=2, padx=padx, pady=pady)
        BorderedFrame(self.inner, borderwidths=(2,2,2,2), bordercolor="systemTextColor", interior=tk.Entry, width=widths[1], justify=tk.CENTER, textvariable=self.fields.wildcard.binary_quad, font=font, state="readonly", readonlybackground="systemTextBackgroundColor").grid(column=bin_col, row=2, padx=padx, pady=pady)
        BorderedFrame(self.inner, borderwidths=(2,2,2,2), bordercolor="systemTextColor", interior=tk.Entry, width=widths[2], justify=tk.CENTER, textvariable=self.fields.wildcard.hex_quad, font=font, state="readonly", readonlybackground="systemTextBackgroundColor").grid(column=hex_col, row=2, padx=padx, pady=pady)
        BorderedFrame(self.inner, borderwidths=(2,2,2,2), bordercolor="systemTextColor", interior=tk.Entry, width=widths[3], justify=tk.CENTER, textvariable=self.fields.wildcard.long, font=font, state="readonly", readonlybackground="systemTextBackgroundColor").grid(column=long_col, row=2, padx=padx, pady=pady)


        tk.Label(self.inner, text="Network:", font=font).grid(column=title_col, row=3, padx=label_padx)
        BorderedFrame(self.inner, borderwidths=(2,2,2,2), bordercolor="systemTextColor", interior=tk.Entry, width=widths[0], justify=tk.CENTER, textvariable=self.fields.network.dotted_quad, font=font, state="readonly", readonlybackground="systemTextBackgroundColor").grid(column=dec_col, row=3, padx=padx, pady=pady)
        BorderedFrame(self.inner, borderwidths=(2,2,2,2), bordercolor="systemTextColor", interior=tk.Entry, width=widths[1], justify=tk.CENTER, textvariable=self.fields.network.binary_quad, font=font, state="readonly", readonlybackground="systemTextBackgroundColor").grid(column=bin_col, row=3, padx=padx, pady=pady)
        BorderedFrame(self.inner, borderwidths=(2,2,2,2), bordercolor="systemTextColor", interior=tk.Entry, width=widths[2], justify=tk.CENTER, textvariable=self.fields.network.hex_quad, font=font, state="readonly", readonlybackground="systemTextBackgroundColor").grid(column=hex_col, row=3, padx=padx, pady=pady)
        BorderedFrame(self.inner, borderwidths=(2,2,2,2), bordercolor="systemTextColor", interior=tk.Entry, width=widths[3], justify=tk.CENTER, textvariable=self.fields.network.long, font=font, state="readonly", readonlybackground="systemTextBackgroundColor").grid(column=long_col, row=3, padx=padx, pady=pady)


        tk.Label(self.inner, text="Broadcast:", font=font).grid(column=title_col, row=4, padx=label_padx)
        BorderedFrame(self.inner, borderwidths=(2,2,2,2), bordercolor="systemTextColor", interior=tk.Entry, width=widths[0], justify=tk.CENTER, textvariable=self.fields.broadcast.dotted_quad, font=font, state="readonly", readonlybackground="systemTextBackgroundColor").grid(column=dec_col, row=4, padx=padx, pady=pady)
        BorderedFrame(self.inner, borderwidths=(2,2,2,2), bordercolor="systemTextColor", interior=tk.Entry, width=widths[1], justify=tk.CENTER, textvariable=self.fields.broadcast.binary_quad, font=font, state="readonly", readonlybackground="systemTextBackgroundColor").grid(column=bin_col, row=4, padx=padx, pady=pady)
        BorderedFrame(self.inner, borderwidths=(2,2,2,2), bordercolor="systemTextColor", interior=tk.Entry, width=widths[2], justify=tk.CENTER, textvariable=self.fields.broadcast.hex_quad, font=font, state="readonly", readonlybackground="systemTextBackgroundColor").grid(column=hex_col, row=4, padx=padx, pady=pady)
        BorderedFrame(self.inner, borderwidths=(2,2,2,2), bordercolor="systemTextColor", interior=tk.Entry, width=widths[3], justify=tk.CENTER, textvariable=self.fields.broadcast.long, font=font, state="readonly", readonlybackground="systemTextBackgroundColor").grid(column=long_col, row=4, padx=padx, pady=pady)


        tk.Label(self.inner, text="Min Host:", font=font).grid(column=title_col, row=5, padx=label_padx)
        BorderedFrame(self.inner, borderwidths=(2,2,2,2), bordercolor="systemTextColor", interior=tk.Entry, width=widths[0], justify=tk.CENTER, textvariable=self.fields.start_ip.dotted_quad, font=font, state="readonly", readonlybackground="systemTextBackgroundColor").grid(column=dec_col, row=5, padx=padx, pady=pady)
        BorderedFrame(self.inner, borderwidths=(2,2,2,2), bordercolor="systemTextColor", interior=tk.Entry, width=widths[1], justify=tk.CENTER, textvariable=self.fields.start_ip.binary_quad, font=font, state="readonly", readonlybackground="systemTextBackgroundColor").grid(column=bin_col, row=5, padx=padx, pady=pady)
        BorderedFrame(self.inner, borderwidths=(2,2,2,2), bordercolor="systemTextColor", interior=tk.Entry, width=widths[2], justify=tk.CENTER, textvariable=self.fields.start_ip.hex_quad, font=font, state="readonly", readonlybackground="systemTextBackgroundColor").grid(column=hex_col, row=5, padx=padx, pady=pady)
        BorderedFrame(self.inner, borderwidths=(2,2,2,2), bordercolor="systemTextColor", interior=tk.Entry, width=widths[3], justify=tk.CENTER, textvariable=self.fields.start_ip.long, font=font, state="readonly", readonlybackground="systemTextBackgroundColor").grid(column=long_col, row=5, padx=padx, pady=pady)
        
        tk.Label(self.inner, text="Max Host:", font=font).grid(column=title_col, row=6, padx=label_padx)
        BorderedFrame(self.inner, borderwidths=(2,2,2,2), bordercolor="systemTextColor", interior=tk.Entry, width=widths[0], justify=tk.CENTER, textvariable=self.fields.end_ip.dotted_quad, font=font, state="readonly", readonlybackground="systemTextBackgroundColor").grid(column=dec_col, row=6, padx=padx, pady=pady)
        BorderedFrame(self.inner, borderwidths=(2,2,2,2), bordercolor="systemTextColor", interior=tk.Entry, width=widths[1], justify=tk.CENTER, textvariable=self.fields.end_ip.binary_quad, font=font, state="readonly", readonlybackground="systemTextBackgroundColor").grid(column=bin_col, row=6, padx=padx, pady=pady)
        BorderedFrame(self.inner, borderwidths=(2,2,2,2), bordercolor="systemTextColor", interior=tk.Entry, width=widths[2], justify=tk.CENTER, textvariable=self.fields.end_ip.hex_quad, font=font, state="readonly", readonlybackground="systemTextBackgroundColor").grid(column=hex_col, row=6, padx=padx, pady=pady)
        BorderedFrame(self.inner, borderwidths=(2,2,2,2), bordercolor="systemTextColor", interior=tk.Entry, width=widths[3], justify=tk.CENTER, textvariable=self.fields.end_ip.long, font=font, state="readonly", readonlybackground="systemTextBackgroundColor").grid(column=long_col, row=6, padx=padx, pady=pady)


        tk.Label(self.inner, text="Next Subnet:", font=font).grid(column=title_col, row=7, padx=label_padx)
        BorderedFrame(self.inner, borderwidths=(2,2,2,2), bordercolor="systemTextColor", interior=tk.Entry, width=widths[0], justify=tk.CENTER, textvariable=self.fields.next_subnet.dotted_quad, font=font, state="readonly", readonlybackground="systemTextBackgroundColor").grid(column=dec_col, row=7, padx=padx, pady=pady)
        BorderedFrame(self.inner, borderwidths=(2,2,2,2), bordercolor="systemTextColor", interior=tk.Entry, width=widths[1], justify=tk.CENTER, textvariable=self.fields.next_subnet.binary_quad, font=font, state="readonly", readonlybackground="systemTextBackgroundColor").grid(column=bin_col, row=7, padx=padx, pady=pady)
        BorderedFrame(self.inner, borderwidths=(2,2,2,2), bordercolor="systemTextColor", interior=tk.Entry, width=widths[2], justify=tk.CENTER, textvariable=self.fields.next_subnet.hex_quad, font=font, state="readonly", readonlybackground="systemTextBackgroundColor").grid(column=hex_col, row=7, padx=padx, pady=pady)
        BorderedFrame(self.inner, borderwidths=(2,2,2,2), bordercolor="systemTextColor", interior=tk.Entry, width=widths[3], justify=tk.CENTER, textvariable=self.fields.next_subnet.long, font=font, state="readonly", readonlybackground="systemTextBackgroundColor").grid(column=long_col, row=7, padx=padx, pady=pady)
