...
class InputSummaryImageFrame(tk.Frame):
    def __init__(self, 
            ...
            usable_hosts = BorderedFrame(cidr_frame, borderwidths=BorderWidths(2,2,2,2), bordercolor="systemTextColor", interior=tk.Entry, width=15, justify=tk.CENTER, textvariable=self.fields.usable_hosts, font=font, state="readonly", readonlybackground="systemTextBackgroundColor")
